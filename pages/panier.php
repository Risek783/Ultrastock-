                        ...
                        ?>
                            ...
                            <li class="list-group-item" style="border:none; margin-bottom:5px; margin-top:5px">
                                <div class="card" style="border: 1px solid black;border-radius:15px;">
                                    <div class=" row no-gutters" style="border: 1px solid black;border-radius:15px; background-color: rgba(230, 230, 230)">
                                        <div id="image" class="col-sm-5" style="display:flex">
                                            <img class="card-img" style="object-fit:cover;border-radius:15px" src=" <?= $produit['image'] ?>">
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <div id="infos">
                                                    ...
                                                    <h5 style="float:right" class="card-title"><b><?= $produit['prix'] ?> €</b></h5>

                                                </div>
                                                <br>
                                                <hr>

                                                <input class="input_panier" type="number" placeholder=<?= $produit['quantite'] ?>>
                                                <div class="text-center">
                                                    <button class="collapsible2">Supprimer du Panier</button>

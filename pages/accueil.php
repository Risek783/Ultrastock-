        ...
        <div class="carousel-item <?= ($i == 0 ? "active" : ""); ?>">
          <div class="carousel_article">
            ...
            <div id="article_produit" class="article_produit">
              ...
              ?>
                <article id="<?= $produit['id'] ?>" class="card" style="margin-bottom: 10px;border-radius:15px; border: 1px solid black;background-color: rgba(250, 250, 250, 0.6); box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24);">
                  <div class=" row no-gutters" style="border: 1px solid black;border-radius:15px">
                    <div id="image" class="col-sm-5" hidden>
                      <img class="card-img" style="max-height: 270px; object-fit:cover;border-radius:15px" src=" <?= $produit['image'] ?>">
                    </div>
                    ...
                    <div class="col-sm-7">
                      <div class="card-body">
                        <div id="infos" hidden>
                          ...
                          <h5 style="float:left" class="card-title"><u><b><?= $produit['nom'] ?></b></u></h5>

                          <b>
                            <h5 style="float:right" class="card-title"><?= $produit['prix'] ?> €</h5>
                          </b>
                        </div>
                        <div id="infos">
                        ...
                        <a href=" description_jeu.php?jeu=<?= $produit['id'] ?>">
                          <button type="button" class="collapsible">
                            <span style="text-align: center;">Voir le produit <i class="fas fa-info-circle"></i> </span>
                          </button>
                        </a>
                        <form method="post" action="../traitements/insererDansPanier.php">
                        <button id="btn_panier" name="produit" value="<?= $produit['id'] ?>" type="submit" class="bouton-panier">
                          <span style="text-align: center;">Mettre dans le panier <i class="fas fa-cart-arrow-down"></i> </span>
                        </button>
                        </form>
